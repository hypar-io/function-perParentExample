...
namespace PerParentOverrides
{
    public class Function
    {
        ...
        private IModelStore<PerParentOverridesInputs> store;

        public async Task<PerParentOverridesOutputs> Handler(PerParentOverridesInputs args, ILambdaContext context)
        {
            ...
            if(this.store == null)
            {
                this.store = new S3ModelStore<PerParentOverridesInputs>(RegionEndpoint.GetBySystemName("us-west-1"));
            }

            var l = new InvocationWrapper<PerParentOverridesInputs,PerParentOverridesOutputs>(store, PerParentOverrides.Execute);
