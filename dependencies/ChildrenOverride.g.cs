...
{
	/// <summary>
	/// Override metadata for ChildrenOverride
	/// </summary>
	public partial class ChildrenOverride : IOverride
	{
	...
	public static class ChildrenOverrideExtensions
    {
		/// <summary>
        /// Apply Children edit overrides to a collection of existing elements
        /// </summary>
        /// <param name="overrideData">The Children Overrides to apply</param>
        ...
        public static List<T> Apply<T>(
            this IList<ChildrenOverride> overrideData,
            IEnumerable<T> existingElements,
            Func<T, ChildrenIdentity, bool> identityMatch,
            Func<T, ChildrenOverride, T> modifyElement) where T : Element
        {
        ...
        /// </summary>
        /// <param name="existingElements">A collection of existing elements to which to apply the overrides.</param>
        /// <param name="overrideData">The Children Overrides to apply — typically `input.Overrides.Children`</param>
        /// <param name="identityMatch">A function returning a boolean which indicates whether an element is a match for an override's identity.</param>
        /// <param name="modifyElement">A function to modify a matched element, returning the modified element.</param>
        /// <typeparam name="T">The element type this override applies to. Should match the type(s) in the override's context.</typeparam>
        /// <returns>A collection of elements, including unmodified and modified elements from the supplied collection.</returns>
        public static void ApplyOverrides<T>(
            ...
            IList<ChildrenOverride> overrideData,
            Func<T, ChildrenIdentity, bool> identityMatch,
            Func<T, ChildrenOverride, T> modifyElement
            ) where T : Element
        {
        ...
        /// </summary>
        /// <param name="edits">The collection of edit overrides (Overrides.Children)</param>
        /// <param name="additions">The collection of add overrides (Overrides.Additions.Children)</param>
        /// <param name="removals">The collection of remove overrides (Overrides.Removals.Children)</param>        /// <param name="identityMatch">A function returning a boolean which indicates whether an element is a match for an override's identity.</param>
        ...
        public static List<T> CreateElements<T>(
            this IList<ChildrenOverride> edits,
            IList<ChildrenOverrideAddition> additions,
            IList<ChildrenOverrideRemoval> removals,            Func<ChildrenOverrideAddition, T> createElement,
            Func<T, ChildrenIdentity, bool> identityMatch,
            Func<T, ChildrenOverride, T> modifyElement,
